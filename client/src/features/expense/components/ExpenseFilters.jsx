    ...
    return (
        <div className="bg-gray-50 p-3 rounded-lg shadow-xs border border-gray-100 mb-4">
            <div className="relative mb-2">
                ...
                <div className="absolute right-1.5 top-1 flex space-x-1 bg-orange-400">
                    <button
                        onClick={() => toggleSection('category')}
                        className={`px-2.5 py-1 text-xs rounded-full transition-all bg-white text-gray-600 border border-gray-200 hover:bg-gray-50 hover:border-gray-300`}
                    >
                    ...
                    <button
                        ...
                        className={`px-2.5 py-1 text-xs rounded-full transition-all ${sort
            ...
            {expandedSection && (
                <div className="mt-1 p-2 bag-gray-50 rounded-md border border-gray-100">
